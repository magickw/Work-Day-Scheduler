...
* Step 2. Using momemt() functions to get the current date and time.<br>
  By comparing the values of time blocks with the value of current hour, the time blocks will be appended classes of past, current or future and thus color coded by using CSS.
<br>
